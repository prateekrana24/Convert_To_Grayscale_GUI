This program allows the user to access any folder containing .bmp files and those files will be added to a listbox that's inside a custom-built PyQt6 GUI. 
